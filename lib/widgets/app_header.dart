            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: LiquidUI.fluid(context, minVal: 10, maxVal: 18)),
                  ...
                  SizedBox(width: LiquidUI.fluid(context, minVal: 10, maxVal: 18)),
                  _buildNavLink(context, LanguageService.instance.tr('nav_exhibitions'), '/exhibitions'),
                  SizedBox(width: LiquidUI.fluid(context, minVal: 10, maxVal: 18)),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _buildDrawerItem(
                    context,
                    title: LanguageService.instance.tr('nav_exhibitions'),
                    subtitle: 'Trade Shows & Global Expos',
                    icon: Icons.storefront_rounded,
                    routeName: '/exhibitions',
                    currentRoute: currentRoute,
                  ),
                  _buildDrawerItem(
                    context,
