  ...
  Widget build(BuildContext context) {
    ...
    final galleryItems = [
      ...
      },
      {
        ...
        'desc': 'Close-up view of kibbled red onion flakes in studio wooden bowl.',
      },
      {
        'title': 'Dehydrated Red Onion Flakes',
        'category': 'PRODUCTS',
      ...
      },
      {
        ...
        'desc': 'Premium presentation of spilling red onion flakes and fresh bulb.',
      },
      {
        'title': 'Dehydrated Red Onion Flakes',
        'category': 'PRODUCTS',
        'image': AppImages.productRedOnionFlakes5,
        'desc': 'Texture shot of 100% pure dehydrated red onion flakes.',
      },
      {
      ...
      },
      {
        ...
        'desc': 'Presentation of Gujarat pink onion minced bits.',
      },
      {
        'title': 'Dehydrated Pink Onion Granules',
        'category': 'PRODUCTS',
      ...
      },
      {
        ...
        'desc': 'Pure export-grade pink onion granules.',
      },
      {
        'title': 'Dehydrated Pink Onion Minced',
        'category': 'PRODUCTS',
        'image': AppImages.productPinkOnionGranules5,
        'desc': 'High-resolution texture shot of dehydrated pink onion bits.',
      },
      {
        'title': 'Dehydrated Garlic Flakes',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicFlakes,
        'desc': 'Crisp sliced garlic cloves in wooden bowl.',
      },
      {
        'title': 'Dehydrated Garlic Flakes',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicFlakes2,
        'desc': 'Pure whole peeled dehydrated garlic cloves and slices.',
      },
      {
        'title': 'Dehydrated Garlic Powder',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicPowder,
        'desc': 'Pure 100% fine garlic powder in wooden bowl, free from anti-caking additives.',
      },
      {
        'title': 'Dehydrated Garlic Powder',
        'category': 'PRODUCTS',
      ...
      },
      {
        ...
        'desc': '80-100 mesh fine garlic powder.',
      },
      {
        'title': 'Dehydrated Garlic Powder',
        'category': 'PRODUCTS',
      ...
      },
      {
        ...
        'desc': 'High-resolution texture shot of export-grade garlic powder.',
      },
      {
        'title': 'Dehydrated Garlic Granules',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicGranules,
        'desc': 'Golden-amber 0.5-1 mm coarse garlic granules in wooden bowl.',
      },
      {
        'title': 'Dehydrated Garlic Granules',
        'category': 'PRODUCTS',
      ...
      },
      {
        ...
        'desc': 'Coarse garlic granules.',
      },
      {
        'title': 'Dehydrated Garlic Granules',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicGranules4,
        'desc': '0.5-1 mm free-flowing garlic granules.',
      },
      {
        'title': 'Dehydrated Garlic Granules',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicGranules5,
        'desc': 'Export-grade garlic granules.',
      },
      {
      ...
      },
      {
        ...
        'desc': '100% pure dehydrated garlic granules.',
      },
      {
        'title': 'Dehydrated Garlic Minced',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicMinced4,
        'desc': 'Close-up view of dehydrated garlic minced and raw garlic bulbs.',
      },
      {
        'title': 'Dehydrated Garlic Minced',
        'category': 'PRODUCTS',
        'image': AppImages.productGarlicMinced5,
        'desc': 'Clean presentation of garlic granules over sliced cloves.',
      },
    ];
