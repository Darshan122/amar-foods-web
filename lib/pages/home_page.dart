...
class _ApplicationCardWidgetState extends State<_ApplicationCardWidget>
  ...
  void initState() {
    ...
    // Subtle playful wobble / shake sequence: tilts left -> right -> left -> right -> settles to 0
    _shakeAnimation = TweenSequence<double>([
      TweenSequenceItem(
        tween: Tween<double>(begin: 0.0, end: -0.022)
            .chain(CurveTween(curve: Curves.easeOut)),
        weight: 15,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: -0.022, end: 0.022)
            .chain(CurveTween(curve: Curves.easeInOut)),
        weight: 25,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: 0.022, end: -0.012)
            .chain(CurveTween(curve: Curves.easeInOut)),
        weight: 25,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: -0.012, end: 0.008)
            .chain(CurveTween(curve: Curves.easeInOut)),
        weight: 20,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: 0.008, end: 0.0)
      ...
      onExit: (_) => _onExit(),
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            final double rot = _shakeAnimation.value;
            // Subtly also translate x based on rotation for natural wobble physics
            final double translationX = rot * 80.0;
            return Transform(
              alignment: Alignment.center,
